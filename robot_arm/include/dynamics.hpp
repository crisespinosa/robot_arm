...
//   m_eff·lc_eff·G            = 5.881·0.320·9.81      ≈ 18.46
    ...
    // =================================================================
    // МАСШТАБЫ ДОМЕННОЙ РАНДОМИЗАЦИИ
    //
    ...
    // дополнительного скейлинга. Значения 0.2..3.0 используются только
    // на этапе обучения PPO через setParamScales() для доменной
    // рандомизации (±40% в среднем). Вне рандомизации — всегда 1.0.
    // =================================================================
